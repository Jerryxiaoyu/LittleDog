...
#model_path = os.path.join(pydrake.getDrakePath(), 'manipulation/models/iiwa_description/urdf/iiwa14_polytope_collision.urdf')
...
def SetupKinova():
    ...
    print("Num of Joints : {}, \n Num of Actuators: {}".format(rb_tree.get_num_positions(), rb_tree.get_num_actuators()))
    return rb_tree